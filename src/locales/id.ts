export const id = {
  ...
  resetPasswordDescription: 'Kode 6 digit telah dikirim ke {{email}}. Masukkan di bawah ini bersama dengan kata sandi baru Anda.',
  oneTimePassword: 'Kata Sandi Sekali Pakai (OTP)',
  checkSpam: 'Tidak menerima kode? Silakan periksa folder spam Anda.',
  newPassword: 'Kata Sandi Baru',
  resetPasswordAndLogin: 'Reset Kata Sandi',
