...
export const id = {
  ...
  createCustomMode: 'Buat Mode Kustom',
  createCustomModeDescription: 'Rancang persona AI Anda sendiri dengan memberikan nama dan prompt sistem. Ini akan dikenakan biaya 150 kredit.',
  customModeList: 'Mode AI Kustom Anda',
  customModeListDescription: 'Kelola kepribadian AI unik yang telah Anda buat.',
  noCustomModes: 'Anda belum membuat mode AI kustom.',
  createOneNow: 'Buat sekarang!',
  confirmModeCreation: 'Konfirmasi Pembuatan Mode',
  confirmModeCreationDescription: 'Anda yakin ingin membuat mode "{{name}}"? Ini akan mengurangi 150 kredit dari akun Anda.',
  customModeCreated: 'Mode Kustom Dibuat!',
  customModeCreatedDescription: 'Mode "{{name}}" sekarang tersedia untuk digunakan.',
  errorCreatingMode: 'Kesalahan Saat Membuat Mode',
  deleteCustomMode: 'Hapus Mode Kustom',
  deleteCustomModeConfirmation: 'Anda yakin ingin menghapus mode "{{name}}"? Tindakan ini tidak dapat dibatalkan.',
  customModeDeleted: 'Mode Dihapus',
  customModeDeletedDescription: 'Mode "{{name}}" telah berhasil dihapus.',
  ...
  faqCustomModeTitle: 'Dapatkah saya membuat mode AI saya sendiri?',
  faqCustomModeContent: 'Ya! Dengan biaya 150 kredit, Anda dapat membuat mode AI kustom Anda sendiri. Buka halaman Pengaturan, temukan bagian "Buat Mode Kustom", beri nama AI Anda, dan tulis prompt sistem terperinci yang mendefinisikan kepribadian, nada, dan keahliannya. Mode tersebut akan muncul di daftar pilihan Mode AI untuk semua obrolan Anda.',
  ...
  howToTopUpDescription: 'Untuk mengisi ulang kredit Anda, silakan hubungi admin kami melalui WhatsApp. Sebutkan nama pengguna Anda dan paket yang diinginkan. Kami akan segera memproses permintaan Anda.',
