...
export const en = {
  ...
  createCustomModeDescription: 'Design your own AI persona by providing a name and a system prompt. This will cost 150 credits.',
  customModeList: 'Your Custom AI Modes',
  customModeListDescription: 'Manage the unique AI personalities you have created.',
  noCustomModes: "You haven't created any custom AI modes yet.",
  createOneNow: 'Create one now!',
  confirmModeCreation: 'Confirm Mode Creation',
  confirmModeCreationDescription: 'Are you sure you want to create the "{{name}}" mode? This will deduct 150 credits from your account.',
  customModeCreated: 'Custom Mode Created!',
  customModeCreatedDescription: 'The mode "{{name}}" is now available for use.',
  errorCreatingMode: 'Error Creating Mode',
  deleteCustomMode: 'Delete Custom Mode',
  deleteCustomModeConfirmation: 'Are you sure you want to delete the "{{name}}" mode? This action cannot be undone.',
  customModeDeleted: 'Mode Deleted',
  customModeDeletedDescription: 'The mode "{{name}}" has been successfully deleted.',
  ...
  achThreeStreakTitle: '3x Streak',
  achThreeStreakDesc: 'Created 3 chats in a row.',
  achTenChatsTitle: 'Chat Collector',
  achTenChatsDesc: 'Created 10 chats.',
  achHundredChatsTitle: 'Serial Chatter',
  achHundredChatsDesc: 'Created 100 chats.',
  achThousandChatsTitle: 'Chat Enthusiast',
  achThousandChatsDesc: 'Created 1,000 chats.',
  achTenThousandChatsTitle: 'Chat Legend',
  ...
  achMemelordDesc: 'Created a meme with the AI.',
  achPromptCrafterTitle: 'Prompt Crafter',
  achPromptCrafterDesc: 'Used a prompt with more than 35 words.',
  achRichPeopleTitle: 'High Roller',
  achRichPeopleDesc: 'Spent 1,000 credits.',
  achImportantPeopleTitle: 'Power User',
  achImportantPeopleDesc: 'Sent more than 10 messages in a single day.',
  achDarkHunterTitle: 'Dark Hunter',
  achDarkHunterDesc: 'Embraced the dark side.',
  ...
  faqCreditsContent: 'Credits are used to access "Pro" AI modes like Storyteller, Sarcastic, Technical, and Philosopher. Each message sent in a Pro mode costs 1 credit. You receive some free credits upon registration, and you can contact the admin to purchase more.',
  ...
  faqCustomModeTitle: 'Can I create my own AI modes?',
  faqCustomModeContent: 'Yes! For a cost of 150 credits, you can create your own custom AI mode. Go to the Settings page, find the "Create Custom Mode" section, give your AI a name, and write a detailed system prompt that defines its personality, tone, and expertise. It will then appear in your AI Mode selection list for all your chats.',
