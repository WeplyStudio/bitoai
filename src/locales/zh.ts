...
export const zh = {
  ...
  createCustomModeDescription: '通过提供名称和系统提示来设计您自己的 AI 角色。这将花费 150 积分。',
  customModeList: '您的自定义 AI 模式',
  customModeListDescription: '管理您创建的独特 AI 角色。',
  noCustomModes: '您还没有创建任何自定义 AI 模式。',
  createOneNow: '立即创建！',
  confirmModeCreation: '确认模式创建',
  confirmModeCreationDescription: '您确定要创建“{{name}}”模式吗？这将从您的账户中扣除 150 积分。',
  customModeCreated: '自定义模式已创建！',
  customModeCreatedDescription: '模式“{{name}}”现在可以使用了。',
  errorCreatingMode: '创建模式时出错',
  deleteCustomMode: '删除自定义模式',
  deleteCustomModeConfirmation: '您确定要删除“{{name}}”模式吗？此操作无法撤销。',
  customModeDeleted: '模式已删除',
  customModeDeletedDescription: '模式“{{name}}”已成功删除。',
  ...
  achThreeStreakTitle: '三连胜',
  achThreeStreakDesc: '连续创建了3个聊天。',
  ...
  achMemelordDesc: '用AI创建了一个表情包。',
  achPromptCrafterTitle: '提示词工匠',
  achPromptCrafterDesc: '使用了超过35个词的提示。',
  achRichPeopleTitle: '大富翁',
  achRichPeopleDesc: '花费了1,000积分。',
  achImportantPeopleTitle: '重要人物',
  achImportantPeopleDesc: '在一天内发送了超过10条消息。',
  achDarkHunterTitle: '黑暗猎手',
  achDarkHunterDesc: '拥抱了黑暗面。',
  ...
  faqCustomModeTitle: '我可以创建自己的 AI 模式吗？',
  faqCustomModeContent: '是的！花费 150 积分，您可以创建自己的自定义 AI 模式。转到“设置”页面，找到“创建自定义模式”部分，为您的 AI 命名，并编写详细的系统提示来定义其个性、语气和专业知识。然后它将出现在您所有聊天的 AI 模式选择列表中。',
  ...
  howToTopUp: '如何充值',
  howToTopUpDescription: '要充值您的积分，请通过WhatsApp联系我们的管理员。提及您的用户名和所需的套餐。我们会尽快处理您的请求。',
  proAccess: '访问所有专业版功能',
