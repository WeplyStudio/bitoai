...
export const ja = {
  ...
  theme: 'テーマ',
  themeDescription: 'アプリケーションのルックアンドフィールを変更します。',
  ...
  themeUpdated: 'テーマが更新されました',
  themeUpdatedMessage: 'アプリケーションのテーマが{{theme}}に変更されました。',
  ...
  faqCreditsContent: 'クレジットは、「ストーリーテラー」、「皮肉屋」、「テクニカル」、「哲学者」などの「プロ」AIモードにアクセスするために使用されます。プロモードで送信された各メッセージには1クレジットがかかります。登録時にいくつかの無料クレジットが付与され、管理者に追加購入を問い合わせることができます。',
