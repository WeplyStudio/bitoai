...
export const ja = {
  ...
  contactAdmin: '管理者に連絡',
  createCustomMode: 'カスタムモードを作成',
  createCustomModeDescription: '名前とシステムプロンプトを指定して、独自のAIペルソナを設計します。これには150クレジットが必要です。',
  customModeList: 'カスタムAIモード',
  customModeListDescription: '作成した独自のAIペルソナを管理します。',
  noCustomModes: 'まだカスタムAIモードを作成していません。',
  createOneNow: '今すぐ作成！',
  confirmModeCreation: 'モード作成の確認',
  confirmModeCreationDescription: 'モード「{{name}}」を作成してもよろしいですか？これにより、アカウントから150クレジットが差し引かれます。',
  customModeCreated: 'カスタムモードが作成されました！',
  customModeCreatedDescription: 'モード「{{name}}」が使用可能になりました。',
  errorCreatingMode: 'モード作成エラー',
  deleteCustomMode: 'カスタムモードを削除',
  deleteCustomModeConfirmation: 'モード「{{name}}」を削除してもよろしいですか？この操作は元に戻せません。',
  customModeDeleted: 'モードが削除されました',
  customModeDeletedDescription: 'モード「{{name}}」が正常に削除されました。',
  ...
  faqCustomModeTitle: '独自のAIモードを作成できますか？',
  faqCustomModeContent: 'はい！150クレジットで、独自のカスタムAIモードを作成できます。設定ページに移動し、「カスタムモードを作成」セクションを見つけ、AIに名前を付け、その個性、トーン、専門知識を定義する詳細なシステムプロンプトを作成します。その後、すべてのチャットのAIモード選択リストに表示されます。',
  ...
  howToTopUp: 'チャージ方法',
  howToTopUpDescription: 'クレジットをチャージするには、WhatsAppで管理者に連絡し、ユーザー名と希望のパッケージをお知らせください。すぐにリクエストを処理します。',
